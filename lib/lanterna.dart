...
class Lanterna extends StatefulWidget {
  const Lanterna({super.key});

  @override
  State<Lanterna> createState() => _LanternaState();
}

class _LanternaState extends State<Lanterna> {
                ...
                if (snapshot.connectionState == ConnectionState.done) {
                  return snapshotData
                      ? ElevatedButton(
                          ...
                          onPressed: () async {
                            if (_piscar && _timer != null && _timer!.isActive) {
                              _timer!.cancel();
                            }
                            await estaAtiva();
                            if (luzLigada) {
